// $Id$
/*
 * WorldEditLibrary Copyright (C) 2010 sk89q <http://www.sk89q.com>
 * 
...
public class WorldEdit extends Plugin {
    ...
    /**
     * The event listener for WorldEdit an Canarymod. Configuration and such is
     * also loaded here as well, although the core of the WorldEdit is actually
     * in com.sk89q.worldedit.WorldEditController and is merely loaded by this
     * listener.
     */
    private final CanaryWorldEditListener listener;
     ...
     */
    public WorldEdit() {
        listener = new CanaryWorldEditListener(new CanaryServerInterface());
    }
     ...
     * @return
     */
    public CanaryWorldEditListener getListener() {
        return listener;
    }
}
